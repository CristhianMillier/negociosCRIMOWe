            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="documento_id" maxlength="10"
                        value="{{ $proveedore->documento->nombre }}" disabled autocomplete="off">
                </div>
                <div class="col-md-6">
                    ...
                    <div class="btn-group" role="group">
                        <input type="number" name="num_documento" id="num_documento" class="form-control"
                            oninput="limitarCaracteres({{ $proveedore->documento->id }})"
                            value="{{ old('num_documento', $proveedore->num_documento) }}" autocomplete="off">
                        <button type="button" class="btn btn-info" style="margin-left: 10px"
                            onclick="buscarDocumento({{ $proveedore->documento->id }})">Buscar</button>
                    </div>
                ...
                <div class="col-md-6">
                    @if ($proveedore->documento->nombre == 'D.N.I.')
                    ...
                    <input type="text" name="razon_social" id="razon_social" class="form-control" maxlength="150"
                        value="{{old('razon_social', $proveedore->razon_social)}}" autocomplete="off">
                    @error('razon_social')
                    <small class="text-danger">{{'*'.$message}}</small>
                    <script>
                ...
                <div class=" col-md-6">
                    ...
                    <input type="text" name="direccion" id="direccion" class="form-control" maxlength="80"
                        value="{{old('direccion', $proveedore->direccion)}}" autocomplete="off">
                    @error('direccion')
                    <small class="text-danger">{{'*'.$message}}</small>
                    <script>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="telefono" id="telefono" class="form-control" maxlength="11"
                        ...
                        value="{{old('telefono', $proveedore->telefono)}}" autocomplete="off">
                    @error('telefono')
                    <small class="text-danger">{{'*'.$message}}</small>
                    <script>
