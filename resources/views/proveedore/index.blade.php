...
<div class="card-body">
    @can('crear-proveedor')
    <a href="{{ route('proveedores.create') }}"><button type="button" class="btn btn-outline-info">Añadir nuevo
            Proveedor</button></a>
    @endcan
    <h5 class="card-title mt-5"><i class="fa-solid fa-table-cells"></i> Tabla Proveedores</h5>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @if ($item->estado == 1)
                                ¿SEGURO QUE QUIERES ELIMINAR EL PROVEEDOR - {{ $item->razon_social }}?
                                @else
                                ¿SEGURO QUE QUIERES RESTAURAR EL PROVEEDOR - {{ $item->razon_social }}?
                                @endif
                            </div>
