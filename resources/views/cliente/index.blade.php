...
<div class="card-body">
    @can('crear-cliente')
    <a href="{{ route('clientes.create') }}"><button type="button" class="btn btn-outline-info">Añadir nuevo
            Cliente</button></a>
    @endcan
    <h5 class="card-title mt-5"><i class="fa-solid fa-table-cells"></i> Tabla Clientes</h5>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @if ($item->estado == 1)
                                ¿SEGURO QUE QUIERES ELIMINAR EL CLIENTRE - {{ $item->razon_social }}?
                                @else
                                ¿SEGURO QUE QUIERES RESTAURAR EL CLIENTRE - {{ $item->razon_social }}?
                                @endif
                            </div>
