            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" maxlength="30"
                        value="{{old('nombre', $marca->nombre)}}" autocomplete="off">
                    @error('nombre')
                ...
                <div>
                    <div class="border-top">
                        ...
                        <a href="{{ route('marcas.index') }}"><button type="button" class="btn btn-outline-danger mt-3">
                                Cancelar
                            </button></a>
                    </div>
                </div>
...
$(document).ready(function() {
    const li = document.getElementById("marca-li");
    li.classList.add("sidebar-item");
    li.classList.add("selected");
    const a = document.getElementById("marca-a");
