...
<div class="card-body">
    @can('crear-marca')
    <a href="{{ route('marcas.create') }}"><button type="button" class="btn btn-outline-info">Añadir nueva
            Marca</button></a>
    @endcan
    <h5 class="card-title mt-5"><i class="fa-solid fa-table-cells"></i> Tabla Marcas</h5>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @if ($item->estado == 1)
                                ¿SEGURO QUE QUIERES ELIMINAR LA MARCA - {{ $item->nombre }}?
                                @else
                                ¿SEGURO QUE QUIERES RESTAURAR LA MARCA - {{ $item->nombre }}?
                                @endif
                            </div>
